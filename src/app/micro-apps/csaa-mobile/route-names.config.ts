...
const CSAA_PAYMENT_ROUTES: NamedRouteConfig[] = [
  {
    ...
    children: [
      ...
      { name: 'csaa.payment.history', path: 'history' },
      { name: 'csaa.payment.history.policy', path: 'history/:policyNumber' },
      ...
      { name: 'csaa.payment.payall', path: 'payall' },
      { name: 'csaa.payment.add-payment-method', path: 'add-payment-method' },
